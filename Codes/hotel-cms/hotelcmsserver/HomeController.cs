...
public class HomeController : Controller
{
    ...
    [HttpGet]
    [Route("/users")]
    public IActionResult ListUsers([FromHeader(Name = "X-ApiKey")] string ApiKey)
    {
        var CorrectApiKey = Environment.GetEnvironmentVariable("API_KEY");
        if (ApiKey != CorrectApiKey)
        {
    ...
    [HttpGet]
    [Route("/vouchers")]
    public IActionResult ListVouchers([FromHeader(Name = "X-ApiKey")] string ApiKey)
    {
        var CorrectApiKey = Environment.GetEnvironmentVariable("API_KEY");
        if (ApiKey != CorrectApiKey)
        {
        ...
        {
            var vouchers = Database.GetVouchers();
            var jsonderulo = JsonSerializer.Serialize(vouchers, new JsonSerializerOptions { WriteIndented = true });
            return Ok(jsonderulo);
        }
    }
    ...
    [HttpPut]
    [Route("/diningupdate/{Id}")]
    public IActionResult ModifyADining(int Id, [FromBody] DiningModel model)
    {
        Database.ModifyDining(Id, model);
        return Ok("Dining has been successfully modified!");
    }

    [HttpPut]
    [Route("/roomtypeupdate/{Id}")]
    public IActionResult ModifyRoomType(int Id, [FromBody] RoomTypesModel model)
    {
        Database.ModifyARoomType(Id, model);
        return Ok("Room type has been successfully modified!");
    }

    [HttpPatch]
    [Route("/diningtatus/{Id}")]
    public IActionResult ModifyADiningStatus(int Id, [FromBody] UpdateDiningTableModel model)
    {
    ...
    [HttpDelete]
    [Route("/users")]
    public IActionResult DeleteAUser([FromBody] UsersModel model)
    {
        Database.DeleteUser(model.Id);
    ...
    [HttpDelete]
    [Route("/roomtype")]
    public IActionResult DeleteRoomType([FromBody] DiningBookingsModel model)
    {
        Database.DeleteARoomType(model.Id);
        return Ok("Room Type has been successfully deleted!");
    }

    [HttpDelete]
    [Route("/room")]
    public IActionResult DeleteRoom([FromBody] RoomsModel model)
    {
        Database.DeleteARoom(model.Id);
        return Ok("Room has been successfully deleted!");
    }

    [HttpDelete]
    [Route("/dining")]
    public IActionResult DeleteDining([FromBody] DiningBookingsModel model)
    {
        Database.DeleteADining(model.Id);
        return Ok("Dining has been successfully deleted!");
    }

    [HttpDelete]
    [Route("/diningtable")]
    public IActionResult DeleteDiningTable([FromBody] DiningTablesModel model)
    {
        Database.DeleteADiningTable(model.Id);
        return Ok("Dining table has been successfully deleted!");
    }

    [HttpDelete]
    [Route("/voucher")]
    public IActionResult DeleteVoucher([FromBody] VouchersModel model)
    {
        Database.DeleteAVoucher(model.Id);
        return Ok("Voucher has been successfully deleted!");
    }

    [HttpDelete]
    [Route("/hotelbooking")]
    public IActionResult DeleteHotelBooking([FromBody] HotelBookingsModel model)
    {
        Database.DeleteAHotelBooking(model.Id);
        return Ok("Hotel Booking has been successfully deleted!");
    }

    [HttpDelete]
    [Route("/diningbooking")]
    public IActionResult DeleteDiningBooking([FromBody] DiningBookingsModel model)
    {
        Database.DeleteADiningBooking(model.Id);
        return Ok("Dining Booking has been successfully deleted!");
    }
