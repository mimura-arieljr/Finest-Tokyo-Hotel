...
function RoomView() {
  ...
  return (
    <div class="main">
      <div class="menu">
        <p class="menu1">
          CONTENT MANAGEMENT SYSTEM || <b>FINEST TOKYO HOTEL©</b> || ROOMS
        </p>
          ...
          <table class="styled-table">
            ...
            <tbody>
              ...
              <tr class="row" key={i}>
                ...
                <td>{datum.RoomNumber}</td>
                <td>{datum.RoomStatus}</td>
                <td><button class="button" onClick={() => roomsDelete(datum.Id)}>DELETE</button></td>
              </tr>
              ))}
            </tbody>
          </table>
          <p class="addbuttonroom"><Link to="/AddRoomForm"  class="button" style={{ textDecoration: 'none' }}><b>ADD ROOM</b></Link></p>
        </div>
      </div>
    </div>
  );
